...
import { UploadImageDto, UpdateImageDto, BulkUploadDto } from '../../dto/request/upload.dto';
import {
    UploadResponseDto,
...
export class UploadController {
    ...
    @ApiResponse({ status: 200, description: 'Image updated successfully', type: UploadResponseDto })
    @ApiResponse({ status: 400, description: 'Bad request' })
    @ApiResponse({ status: 401, description: 'Unauthorized' })
    ...
    @ApiResponse({ status: 201, description: 'Images uploaded successfully', type: BulkUploadResponseDto })
    @ApiResponse({ status: 400, description: 'Bad request' })
    @ApiResponse({ status: 401, description: 'Unauthorized' })
    ...
    @ApiResponse({ status: 200, description: 'Statistics retrieved successfully', type: UploadStatsResponseDto })
    @ApiResponse({ status: 401, description: 'Unauthorized' })
    @Roles(UserRoleEnum.ADMIN, UserRoleEnum.MANAGER, UserRoleEnum.DEV)
    ...
    @ApiResponse({ status: 200, description: 'Images retrieved successfully', type: ImagesResponseDto })
    @ApiResponse({ status: 401, description: 'Unauthorized' })
    async getImagesByType(@Param('type') type: ImageEnum): Promise<ImagesResponseDto> {
