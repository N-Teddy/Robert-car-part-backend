...
export class AuditLogController {
    ...
    @ApiQuery({ name: 'entity', required: false, type: String, description: 'Filter by entity' })
    @ApiQuery({ name: 'route', required: false, type: String, description: 'Filter by route' })
    ...
    async findAll(@Query() filterDto: AuditLogFilterDto): Promise<PaginatedAuditLogResponseDto> {
        try {
